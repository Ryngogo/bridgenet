                ...
                <div class="post-single-info">
                  <div class="post-single-80">                 
                      ...
                      <?php
                        ...
                        echo $cat_title;
                       ?></h3>
                      <h1 class="post-single-title"><?php echo $post_title; ?></h1>
                  ...
                  <div class="post-main">
                    <img class="d-block" style="width:100%;height:400px" src="./img/<?php echo $post_image; ?>" alt="<?php echo $post_title; ?>" />
                    <p class="mt-4" style="font-family:verdana" >
                      <?php echo $post_des; ?>
                    </p>
                  </div>
                </div>         
